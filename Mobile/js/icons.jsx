/* icons.jsx — lucide-style inline SVG icon set (24×24, 1.75 stroke) */
(function () {
  const P = {
    ...
    microscope: '<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M15 9V6a2 2 0 0 0-2-2h-1a1 1 0 0 1-1-1"/><path d="M9 9v3a1 1 0 0 0 1 1h4"/>',
  ...
  function Icon({ name, size = 20, stroke = 1.75, className = '', style = {}, fill = 'none' }) {
    const d = P[name];
    if (!d) return null;
